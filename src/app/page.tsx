  ...
  return (
    ...
    signIn("google", {
      callbackUrl: "/dashboard",
                  ...
                  className="cursor-pointer w-full flex items-center justify-center gap-3 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 py-3.5 px-4 rounded-xl font-medium hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-all shadow-sm group"
                >
